...
if __name__ =="__main__":
    # dict = {"username":"passwd","username":"passwd", "username":"passwd"}
    while True:
        name = input("可随意输入或不输入,需按回车确认")
        # password = input("请输入密码")
        wc = WeChatSpider(browser="F:\py\Google\Chrome\Application\chromedriver", url="https://mp.weixin.qq.com/", te=name)
